...
export default function AddVehicle() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6 md:p-8 font-sans text-slate-800 pb-24">
      {/* Page Header */}
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-slate-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-10 flex justify-end gap-3 px-8">
