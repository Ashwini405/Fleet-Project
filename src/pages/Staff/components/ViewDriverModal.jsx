...
// export default function ViewDriverModal({ isOpen, onClose, staff }) {
...
//               <p className="text-sm text-gray-500 mt-1">Review all assigned driver information</p>
//             </div>
...
//                     <p className="text-sm text-gray-500">Driver ID • {staff.id}</p>
//                   </div>
//                 </div>
//               </div>
            ...
            <div className="space-y-4">
              <div className="p-5 bg-white rounded-3xl border border-gray-100">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs uppercase tracking-[0.3em] text-slate-400 mb-2">Assigned Since</p>
                    <p className="text-sm font-bold text-slate-900">{staff.created_at || 'N/A'}</p>
                  </div>
                  <CalendarCheck className="w-5 h-5 text-blue-600" />
                </div>
              </div>
