      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
        ...
        >
          ...
          <div className="p-6 overflow-y-auto min-h-[300px]">
            <form id="add-employee-form" className="space-y-6" onSubmit={(e) => { e.preventDefault(); onClose(); }}>
              {activeTab === 'personal' && (
          ...
          <div className="p-5 border-t border-gray-100 flex gap-3 shrink-0 bg-gray-50/50">
            ...
            <button type="submit" form="add-employee-form" className="flex-1 py-3 text-sm font-bold text-white bg-slate-900 hover:bg-slate-800 rounded-xl transition-colors shadow-sm shadow-slate-900/20">
              Complete Profile
            </button>
          </div>
        </motion.div>
