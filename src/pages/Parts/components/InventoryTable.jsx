...
export default function InventoryTable({
  ...
  const [issuingItem, setIssuingItem] =
    useState(null);
        ...
        <table className="w-full text-left border-collapse">
          ...
          <thead>
            ...
            <tr className="border-b border-slate-200 bg-white sticky top-0 z-10 text-slate-500 text-[10px] font-bold uppercase tracking-widest shadow-sm">
              ...
              <th className="py-2 px-2 md:py-5 md:px-5 w-2/5">

                Item

              </th>

              <th className="py-2 px-2 md:py-5 md:px-5 w-1/5 hidden sm:table-cell">

                Brand

              </th>

              <th className="py-2 px-2 md:py-5 md:px-5 w-1/5 text-center">

                Stock

              </th>

              <th className="py-2 px-2 md:py-5 md:px-5 w-1/5 text-right">
              ...
              return (
                ...
                >
                  ...
                  <td className="py-2 px-2 md:py-5 md:px-5">
                    ...
                    <span className="font-bold text-slate-800 tracking-tight block text-xs md:text-sm">
                    ...
                    {item.partCode && (
                      ...
                      <span className="text-[10px] text-slate-400 font-medium tracking-wide mt-0.5 block">
                  ...
                  <td className="py-2 px-2 md:py-5 md:px-5 text-center">
                    ...
                    <div className="flex justify-center">
                      ...
                      <span
                        className={`inline-flex items-center text-xs font-black tracking-widest px-3 py-1.5 rounded-lg border ${qtyColor}`}
                      >
