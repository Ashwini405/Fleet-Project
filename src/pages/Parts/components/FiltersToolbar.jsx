    ...
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
      ...
      <div className="flex flex-wrap items-center gap-2 px-4 pt-4 pb-3">
        ...
        {hasActive && (
          ...
          <button
            onClick={handleClear}
            className="flex items-center gap-1.5 rounded-xl border border-red-200 bg-red-50 px-3 py-2.5 text-sm font-bold text-red-600 hover:bg-red-100 transition"
          >
      ...
      <div className="flex flex-wrap items-center gap-2 px-4 pb-3">
        ...
        {[
          ['showExpiring', 'Expiring Soon'],
          ['showCritical', 'Critical Only'],
