      ...
      <div className="rounded-2xl border border-amber-100 bg-amber-50 p-4">
            ...
            {lowStock.slice(0, 3).map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`text-[9px] font-bold px-2 py-0.5 rounded-full border ${priorityColor[status]}`}
                  >
                    {status}
                  </span>
        ...
        {lowStock.length > 0 && (
          ...
          <button
            ...
            className="mt-3 w-full flex items-center justify-center gap-1 rounded-xl bg-amber-600 px-3 py-2 text-[11px] font-bold text-white hover:bg-amber-700 transition"
          >
      ...
      <div className="rounded-2xl border border-orange-100 bg-orange-50 p-4">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-orange-600">
              {expiring.length} items within 90 days
            </p>
        ...
        <div className="space-y-2">
          ...
          {expiring.length === 0 && (
            ...
            <p className="text-xs text-orange-500 text-center py-4">
      ...
      <div className="rounded-2xl border border-violet-100 bg-violet-50 p-4">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-violet-600">
              {pendingPOs.length} awaiting approval
            </p>
        ...
        <div className="space-y-2">
          ...
          {pendingPOs.length === 0 && (
            ...
            <p className="text-xs text-violet-400 text-center py-4">
