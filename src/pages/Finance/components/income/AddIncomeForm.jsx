...
export default function AddIncomeForm({ onBack, onSaved, initialTripId = null, initialVehicleId = null, initialIncome = null }) {
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      rentalDesc: initialIncome.rental_description || '',
      rentalStart: toDateInputValue(initialIncome.rental_start_date),
      rentalEnd: toDateInputValue(initialIncome.rental_end_date),
