...
import { FiArrowLeft, FiEye, FiX, FiInbox, FiSearch, FiCalendar, FiChevronLeft, FiChevronRight, FiDownload, FiPrinter } from 'react-icons/fi';
...
const FILTERS = ['All', 'Labour Charge'];
const filterMatch = {
  'Labour Charge': ['Labour Charge'],
};
        ...
        <div className="overflow-x-auto">
          {paginated.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 gap-3 text-gray-400">
              ...
              <p className="text-xs text-gray-400">{rawTxns.length === 0 ? 'Labour charges will appear here once repairs are registered against this vendor.' : 'Try clearing the filters to see all transactions.'}</p>
            </div>
          ) : (
