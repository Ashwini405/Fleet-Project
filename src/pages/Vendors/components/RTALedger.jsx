...
const CATEGORY_LABEL = 'RTA EXPENSES';
const FILTERS = ['All', 'RTA Fees', 'Payments', 'Adjustments'];
const filterMatch = {
  'RTA Fees':  ['RTA Fee'],
  Payments:    ['Payment'],
          ...
          {paginated.length === 0 ? (
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-50">
                {paginated.map(txn => (
                  <tr key={txn.id} className="hover:bg-rose-50/30 transition-colors">
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden max-h-[90vh] flex flex-col" style={{ animation: 'modalSlideIn 0.2s ease-out' }}>
            <div className="flex justify-between items-center px-5 py-4 border-b border-gray-100 shrink-0">
              <div>
                ...
                <p className="text-[11px] text-rose-600 font-semibold mt-0.5">{vendor.name} · RTA Expenses</p>
              </div>
