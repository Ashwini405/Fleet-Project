...
const inputCls    = "w-full p-3 bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 text-sm";
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input type="text" value={form.name} onChange={e => set('name', e.target.value)}
                    placeholder="e.g. Ramesh Labour Contractor" className={errors.name ? inputErrCls : inputCls} />
