          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden max-h-[90vh] flex flex-col" style={{ animation: 'modalSlideIn 0.2s ease-out' }}>
            ...
            <div className="p-5 space-y-0 overflow-y-auto">
              {[
                ...
                selectedTxn.ref     ? [selectedTxn.type === 'Scrap Sale' ? 'Receipt Ref' : 'Reference', null, <span className="text-sm font-bold text-gray-700 bg-gray-100 px-2.5 py-1 rounded-lg">{selectedTxn.ref}</span>] : null,
                selectedTxn.tyreNo  ? ['Tyre Number', null, <span className="text-sm font-bold text-rose-700 bg-rose-50 border border-rose-200 px-2.5 py-1 rounded-lg font-mono">{selectedTxn.tyreNo}</span>] : null,
